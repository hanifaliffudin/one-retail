      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex xl:order-2">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-neutral-n-100 rounded-lg xl:hidden hover:bg-gray-100 focus:outline-none ring-[1px] ring-[#CFD1D4]"
          ...
          <ul className="flex flex-col p-4 xl:p-0 mt-4 text-neutral-n-70 font-medium border border-gray-100 rounded-lg bg-gray-50 xl:flex-row xl:space-x-8 xl:mt-0 xl:border-0 xl:bg-white ">
            ...
            <li>
              ...
              <AnimatePresence initial={false}>
                {dropdownProduct && (
                  <motion.div
                    className="absolute left-28 mt-2 z-50"
                    key="content"
                    initial="collapsed"
                    animate="open"
                    exit="collapsed"
                        ...
                        <div className="bg-neutral-n-10 h-full rounded-xl px-4 py-5">
                          ...
                          >
                            <div className="flex gap-x-4 items-start">
                              <img src="/icons/oms-icon-green.svg" alt="oms" />
                              <div className="div">
                              ...
                              <div className="flex gap-x-3 items-start">
                                ...
                                <div>
                                  ...
                                  <p className="text-neutral-n-70 font-normal text-sm">
                                    ...
                                    efficiency, and drive sales growth for your
                                    business.
                                  </p>
                                </div>
                              </div>
                          ...
                          >
                            <div className="flex gap-x-4 items-start">
                              <img src="/icons/crm-icon-green.svg" alt="crm" />
                              <div className="div">
                                <div className="flex justify-between items-center">
                                  <h2 className="font-medium text-base">
                                    Customer Relationship Management
                                ...
                                <p className="text-neutral-n-70 text-sm font-normal mt-2">
                                  ...
                                  help businesses manage and optimize customer
                                  interactions by storing and organizing
                                  customer data.
                                </p>
                              </div>
                            </div>
                              ...
                              <div className="flex gap-x-3 items-start">
                                ...
                                <div>
                                  ...
                                  <p className="text-neutral-n-70 font-normal text-sm">
                                    ...
                                    customer insights to enhance relationships.
                                  </p>
                                </div>
                              </div>
