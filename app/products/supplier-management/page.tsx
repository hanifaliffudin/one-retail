...
const SupplierManagementPage = () => {
  ...
  return (
    <main className="max-w-screen-2xl mx-auto">
      <section id="overview">
        <motion.div
          className="mt-[183px] mb-[54px] sm:h-[510px] h-[660px] rounded-[20px] bg-diamond-gradient sm:mx-12 max-sm:mx-4 max-sm:px-4 max-sm:pt-5 relative"
          initial={{ opacity: 0 }}
          animate={{
            opacity: 1,
          ...
          <div className="absolute z-10 sm:top-[130px] top-10 sm:left-24">
            ...
            >
              <p className="font-medium max-sm:px-4 sm:text-xl text-sm sm:leading-9 leading-[25px] text-justify max-w-[948px]">
                ...
                their supplier and allow them to announce any important message
                to supplier instantly throughs announcement feature
              </p>
            </motion.div>
