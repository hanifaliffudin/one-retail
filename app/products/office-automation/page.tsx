          ...
          <div className="grid grid-cols-12 mt-20 sm:px-24 px-4 mb-[60px]">
            <div className="col-span-12 sm:col-span-7 sm:max-w-[574px] flex items-center">
              ...
              >
                ...
                <p className="text-neutral-dark mb-4">
                  Enhance your team productivity, efficiency, and collaboration
                  by reducing manual effort and start improving communication
                  and information management among many stakeholders
                </p>
              </motion.div>
            </div>
        ...
        >
          <div className="flex flex-col items-center px-4">
            <h2 className="font-bold text-center text-[#0A0A0A] sm:text-[32px] text-xl sm:leading-[48px] mb-4 md:w-[986px]">
              All-In-One Retail <span className="text-primary">Solutions</span>{" "}
              to Gain a Competitive Edge in Today's Customer-centric Market
            </h2>
            <p
              id="ees"
              className="text-center max-sm:text-sm text-[#667085] mb-16 px-4 md:w-[824px]"
            >
              Unlock powerful customer relationships with harness the potential
              of our Customer Relationship Management for unparalleled growth
