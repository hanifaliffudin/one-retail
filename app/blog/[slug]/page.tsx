          ...
          <div className="sm:col-span-3 col-span-4 ">
            <div className="sm:mb-24 mb-10">
              ...
              <p>
                ...
                through the rise of digital technology. Digital gadgets, such as
                smartphones, laptops, and tablets, have transformed the way we
                communicate, access information, and even entertain ourselves.
                <br />
                <br />
                With digital gadgets, we can access the internet from just about
                anywhere in the world, stream movies and TV shows, and even
                control our home appliances with a simple voice command. Digital
                gadgets have also made it easier than ever to work remotely,
                collaborate with colleagues, and stay connected with friends and
                family.
                <br />
                <br />
