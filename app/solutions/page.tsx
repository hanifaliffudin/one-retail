                ...
                {indexTabs == 0 && (
                  ...
                  >
                    ...
                    <div className="border border-[#E0E0E0] rounded-lg p-5 col-span-3 sm:col-span-1">
                      ...
                      <p className="my-5 text-neutral-n-90 max-sm:text-sm">
                        Revolutionize the checkout experience with our Self
                        Check Out (SCO) feature, enabling customers to scan and
                        pay for items themselves, reducing queues and enhancing
                        convenience.
                      </p>
                      <Link
                        href="#"
                    ...
                    <div className="border border-[#E0E0E0] rounded-lg p-5 col-span-3 sm:col-span-1">
                      ...
                      <p className="my-5 text-neutral-n-90 max-sm:text-sm">
                        Empower retail customers with seamless
                        self-ordering—scan, browse, and shop effortlessly.
                        Enhance efficiency, reduce wait times, and deliver a
                    ...
                    <div className="grid grid-cols-3 gap-6 md:mt-10 mt-6 md:mb-20 mb-10 px-4 sm:px-0">
                      <div className="border border-[#E0E0E0] rounded-lg p-5 col-span-3 sm:col-span-1">
                        ...
                        <p className="my-5 text-neutral-n-90 max-sm:text-sm">
                          ...
                          loyalty programs with our intuitive POS system.
                      ...
                      <div className="border border-[#E0E0E0] rounded-lg p-5 col-span-3 sm:col-span-1">
                        ...
                        <p className="my-5 text-neutral-n-90 max-sm:text-sm">
                          Streamline daily operations with our feature,
                          empowering staff to efficiently manage tasks, replace
                          manual data entry, and eliminate paperwork for a
                          seamless cafe operation.
                        </p>
                        <Link
                          href="#"
                          className="flex items-center text-primary font-medium text-sm max-sm:text-xs"
                  ...
                  >
                    <div className="grid grid-cols-3 gap-6 md:mt-10 mt-6 md:mb-20 mb-10 px-4 sm:px-0">
                      <div className="border border-[#E0E0E0] rounded-lg p-5 col-span-3 sm:col-span-1">
                        ...
                        <p className="my-5 text-neutral-n-90 max-sm:text-sm">
                          Enhance your restaurant operations with our POS
                          system. Record transactions, and efficiently manage
                          sales. Integrate loyalty programs for customer
                      ...
                      <div className="border border-[#E0E0E0] rounded-lg p-5 col-span-3 sm:col-span-1">
                        ...
                        <p className="my-5 text-neutral-n-90 max-sm:text-sm">
                          ...
                          technology to gather and analyze data, driving
                          business performance and ensuring customer
                          satisfaction.
                        </p>
                        <Link
                          href="#"
                      ...
                      <div className="border border-[#E0E0E0] rounded-lg p-5 col-span-3 sm:col-span-1">
                        ...
                        <p className="my-5 text-neutral-n-90 max-sm:text-sm">
                          Enabling restaurant staff to effortlessly manage
                          tasks, digitize data entry, and eliminate paper-based
                          processes for a smooth restaurant operation.
                        </p>
                        <Link
                          href="#"
                          className="flex items-center text-primary font-medium text-sm max-sm:text-xs"
